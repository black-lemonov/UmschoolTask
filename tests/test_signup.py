...
def test_signup_w_correct_firstname_and_lastname():
    ...
    expected_student = domain.Student(firstname=correct_firstname, lastname=correct_lastname)
...
def test_signup_w_double_lastname():
    ...
    student_w_double_lastname = domain.Student(firstname=correct_firstname, lastname=double_lastname)
